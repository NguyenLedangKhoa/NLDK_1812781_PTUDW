...
<?php
    ...
    // Phải chỉnh sửa lại
    $mailer->Username = "Nguyenledangkhoa2000@gmail.com"; // GMAIL username
    $mailer->Password = "04182015"; // GMAIL password
    $mailer->AddAddress($mail, $ten); //email người nhận
    $mailer->AddCC("Nguyenledangkhoa3012@gmail.com", "Admin K3mart"); // gửi thêm một email cho Admin
    // Chuẩn bị gửi thư nào
    $mailer->FromName = 'K3mart'; // tên người gửi
    $mailer->From = 'Nguyenledangkhoa2000@gmail.com'; // mail người gửi
